...
from vllm_mxext.engine.trtllm_engine import TRTLLMEngine
...
class TRTLLM(LLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.llm_engine = TRTLLMEngine.from_engine_args(engine_args, usage_context=UsageContext.LLM_CLASS)
